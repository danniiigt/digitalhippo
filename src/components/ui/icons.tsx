...
export const Icons = {
  ...
  calendarAmpliado: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
  ...
  vacaciones: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      viewBox="0 0 25 26"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        d="M0.5 24.9684C1.39185 23.8638 2.72116 22.5593 4.084 22.7913C5.56266 23.0429 5.77488 24.6876 7.156 24.9684C8.73859 25.2902 9.68881 23.0509 11.764 22.7913C13.6127 22.56 13.8409 24.1036 15.1773 24.7211C15.7046 24.9647 16.1743 24.9674 16.372 24.9684C18.2468 24.978 18.9295 23.0115 20.468 22.7913C21.1485 22.6938 22.1584 22.915 23.54 24.4241"
        stroke="#ED5BCB"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M15 18.8923C19.5 19.4279 23.0792 21.3552 24.5 21.3552"
        stroke="#ED5BCB"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M0.5 20.4993C2.0001 20.3908 4.5941 17.803 10.0849 18.4647C10.2239 18.4815 10.3623 18.4987 10.5 18.5164"
        stroke="#ED5BCB"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M22.3857 10.6419C23.1283 6.20652 20.1741 1.95046 15.7874 1.13578C11.4007 0.321099 7.2426 3.25633 6.5 7.69174L22.3857 10.6419Z"
        stroke="#ED5BCB"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M17.2523 9.5706C17.9244 5.17238 17.1817 1.34495 15.5933 1.02182C14.0048 0.698696 12.1722 4.00219 11.5 8.40047L17.2523 9.5706Z"
        stroke="#ED5BCB"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  vacacionesBlanco: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      viewBox="0 0 25 26"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
