...
var get_payload_1 = require("../lib/get-payload");
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                                success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/gracias?orderId=").concat(order.id),
                                cancel_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/carrito"),
